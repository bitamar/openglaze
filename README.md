[![Build Status](https://travis-ci.org/bitamar/openglaze.svg)](https://travis-ci.org/bitamar/openglaze)

# Drupal 7 - Install Profile Openglaze
...
Clone the project from [GitHub](https://github.com/Gizra/openglaze).
...
6. Makes a symlink within the /www/profiles directory to the /openglaze
   directory.
7. Run the Drupal installer (Drush) using the Openglaze profile.
